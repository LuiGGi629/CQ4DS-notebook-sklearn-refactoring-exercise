...
class TitanicModelCreator:
    ...
    def run(self):
        ...
        X_train_numerical_imputed_scaled = model.robust_scaler.transform(X_train_numerical_imputed)
        ...
        X_test_numerical_imputed_scaled = model.robust_scaler.transform(X_test_numerical_imputed)
